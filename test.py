...
class CliffordFrameSimulator:
    ...
    def _handle_H(self, instr: CliffordInstruction):
        ...
        # old phys_q is discarded logically; we leave its frame as is but it
        # no longer corresponds to a logical qubit.
    ...
    def _handle_CNOT(self, instr: CliffordInstruction):
        ...
        # ancillas
        a1 = self._alloc_ancilla()
        a2 = self._alloc_ancilla()
...
def test_random_circuits(num_tests=5, depth=5, num_qubits=2):
    gates_1q = ["H", "S", "X", "Y", "Z"]
    gates_2q = ["CNOT"]
    ...
    for t in range(num_tests):
        ...
        run_equivalence_test(prog, f"Random circuit #{t+1}")
...
if __name__ == "__main__":
    ...
    test_CNOT()
    test_HCNOTS()
    test_random_circuits(num_tests=5, depth=4, num_qubits=2)
    print("\nAll tests passed.")
